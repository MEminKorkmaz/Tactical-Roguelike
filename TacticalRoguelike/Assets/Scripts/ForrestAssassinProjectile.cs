...
public class ForrestAssassinProjectile : MonoBehaviour
{
    public GameObject ForrestAssassinProjectilePrefab;
    ...
    void OnTriggerEnter2D(Collider2D col){
        if(col.gameObject.tag == "Ally"){
            ...
            GameObject go = Instantiate(ForrestAssassinProjectilePrefab , transform.position , transform.rotation);
            Destroy(go , 5f);
            Destroy(gameObject);
        }
    }
