...
public class ForrestBigGuyProjectile : MonoBehaviour
{
    public GameObject ForrestBigGuyProjectilePrefab;
    ...
    void OnTriggerEnter2D(Collider2D col){
        if(col.gameObject.tag == "Ally"){
            ...
            GameObject go = Instantiate(ForrestBigGuyProjectilePrefab , transform.position , transform.rotation);
            Destroy(go , 5f);
            Destroy(gameObject);
        }
    }
